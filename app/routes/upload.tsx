...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File  }) => {
        if (file.type !== 'application/pdf') {
            return setStatusText('Error: Selected file is not a PDF');
        }
        ...
        if(!imageFile.file) {
            ...
            console.error('convertPdfToImage returned no file', imageFile.error);
            // display the underlying message if available
